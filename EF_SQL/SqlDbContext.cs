...
namespace EF_SQL
{
    public class SqlDbContext : DbContext
    {
        ...
        public DbSet<DA_BOM> DA_BOMs { get; set; }
        public DbSet<DA_PAYPERSON> DA_PAYPERSONs { get; set; }
        public DbSet<DA_GROSS> DA_GROSSs { get; set; }
        public DbSet<DA_ELSEGROSS> DA_ELSEGROSSs { get; set; }
        public DbSet<DA_PAYLOSS> DA_PAYLOSSs { get; set; }
        public DbSet<DA_PAYMONTH> DA_PAYMONTHs { get; set; }
        public DbSet<DA_CLENTNAME> DA_CLENTNAME { get; set; }
        public DbSet<DA_CLENTCODE> DA_CLENTCODE { get; set; }
        public DbSet<DA_STAORE> DA_STAORE { get; set; }
        public DbSet<DT_INSTORE> DT_INSTORE { get; set; }//
        public DbSet<DA_DATEINSTORE> DA_DATEINSTORE { get; set; }//
        public DbSet<DA_ATTENDANCE> DA_ATTENDANCE { get; set; }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DA_PAYLOSS>().Property(e => e.CRT_DATE).HasDefaultValueSql("GETDATE()");
            modelBuilder.Entity<DA_PAYMONTH>().Property(e => e.CRT_DATE).HasDefaultValueSql("GETDATE()");
            modelBuilder.Entity<DA_BOM>().Property(e => e.CRT_DATE).HasDefaultValueSql("GETDATE()");
            modelBuilder.Entity<DA_PAYPERSON>().Property(e => e.CRT_DATE).HasDefaultValueSql("GETDATE()");
            modelBuilder.Entity<DA_GROSS>().Property(e => e.CRT_DATE).HasDefaultValueSql("GETDATE()");
            modelBuilder.Entity<DA_ELSEGROSS>().Property(e => e.CRT_DATE).HasDefaultValueSql("GETDATE()");
            modelBuilder.Entity<DT_INSTORE>().Property(e => e.CRT_DATE).HasDefaultValueSql("GETDATE()");
